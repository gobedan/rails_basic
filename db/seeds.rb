...
tests = Test.create!([{title: 'Strength of materials', level: 3, category_id: categoies[2][id]}, 
              {title: 'Binary tree search algorithms', level: 3, category_id: categoies[0][id]},
              {title: 'Strength of materials BASIC', level: 2, category_id: categoies[2][id]}, 
              {title: 'What is your favorite movie genre?', level: 1, category_id: nil},
              {title: 'Child Education', level: 2, category_id: categoies[1][id]}
             ])
