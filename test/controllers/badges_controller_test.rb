...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { category_id: @badge.category_id, icon_file: @badge.icon_file, level: @badge.level, name: @badge.name, test_id: @badge.test_id } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { category_id: @badge.category_id, icon_file: @badge.icon_file, level: @badge.level, name: @badge.name, test_id: @badge.test_id } }
